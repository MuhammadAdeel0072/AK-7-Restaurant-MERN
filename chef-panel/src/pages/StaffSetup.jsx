            ...
            <div className="w-full max-w-md bg-[#1a1d23] border border-white/5 rounded-[2rem] p-10 shadow-2xl relative overflow-hidden group">
                ...
                <div className="text-center mb-10 relative">
                    ...
                    <p className="text-xs font-medium text-white/40 uppercase tracking-[0.3em]">
                        {step === 1 ? 'Verify Culinary HQ Invitation' : 'Setup Your Account'}
                    </p>
                </div>
                    ...
                    {step === 1 ? (
                        ...
                        >
                            <div className="space-y-2">
                                <label className="text-[10px] font-bold text-white/60 uppercase tracking-widest ml-1">Official Email</label>
                        ...
                        >
                            ...
                            >
                                {loading ? <RefreshCw className="w-5 h-5 animate-spin" /> : (
                                    <>Activate Account <ShieldCheck size={20} /></>
                                )}
                            </button>
                        </motion.form>
                    )}
