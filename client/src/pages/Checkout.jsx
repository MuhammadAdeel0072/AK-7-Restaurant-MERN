...
const Checkout = () => {
  ...
  const submitHandler = async () => {
    ...
    try {
      ...
      navigate(`/order-tracker?id=${createdOrder._id}`);
    } catch (error) {
            ...
            {step === 1 && (
              ...
              >
                <div className="card-premium p-10 sm:p-12 shadow-2xl group hover:border-gold/20 transition-all">
                  <h2 className="text-3xl font-serif font-black text-white mb-10 border-b border-white/5 pb-6">Delivery Identity</h2>
                  <div className="space-y-8">
                    <div className="space-y-3">
                        <label className="text-[10px] uppercase font-black text-gold tracking-widest block ml-1">Secure Street Address</label>
                        <input 
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                        <div className="space-y-3">
                            <label className="text-[10px] uppercase font-black text-gold tracking-widest block ml-1">City</label>
                            <input 
                                className="w-full bg-white/[0.03] border border-white/10 rounded-2xl p-5 focus:border-gold outline-none text-white transition-all font-bold shadow-inner"
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] uppercase font-black text-gold tracking-widest block ml-1">Postal Code</label>
                            <input 
                                className="w-full bg-white/[0.03] border border-white/10 rounded-2xl p-5 focus:border-gold outline-none text-white transition-all font-bold shadow-inner"
                                placeholder="00000"
                  ...
                  <button onClick={nextStep} className="mt-12 w-full bg-gold text-charcoal font-black py-5 rounded-[2rem] flex items-center justify-center gap-3 uppercase tracking-[0.2em] text-xs shadow-2xl shadow-gold/20 hover:bg-yellow-400 active:scale-95 transition-all">
                  ...
                  <div className="pt-10 border-t border-white/5">
                    <div className="card-premium bg-gold/5 border border-gold/10 p-8 flex items-center gap-6">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-gray-500 font-black uppercase tracking-widest text-[9px]">{shippingAddress.city}, {shippingAddress.postalCode}</p>
                        </div>
                    </div>
                  </div>
